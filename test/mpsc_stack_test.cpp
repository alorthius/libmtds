...
class MpscStackTest : public ::testing::Test {
protected:
    void SetUp() override {
        c1.push(1);
        c2.push(2);
    ...
    mtds::MpscStack<int> c0;
    mtds::MpscStack<int> c1;
    mtds::MpscStack<int> c2;
};

TEST_F(MpscStackTest, IsEmptyInitially) {
    EXPECT_EQ(c0.size(), 0);
...
TEST_F(MpscStackTest, TryDequeueWorks) {
